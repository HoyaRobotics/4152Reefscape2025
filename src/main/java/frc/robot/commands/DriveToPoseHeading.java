...
public class DriveToPoseHeading extends Command {
    ...
    public DriveToPoseHeading(Drive drive, Supplier<Pose2d> poseSupplier, Optional<Angle> angleDeltaTolerance) {
    ...
    public void execute() {
        ...
        double driveVelocityScalar =
                driveController.calculate(currentPose.getTranslation().getDistance(targetPose.getTranslation()));
