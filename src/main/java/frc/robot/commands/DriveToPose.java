...
public class DriveToPose extends Command {
  ...
  private final ProfiledPIDController xController = new ProfiledPIDController(LINEAR_KP, LINEAR_KI, LINEAR_KD,
      new TrapezoidProfile.Constraints(LINEAR_MAX_VELOCITY, LINEAR_MAX_ACCELERATION));

  private final ProfiledPIDController yController = new ProfiledPIDController(LINEAR_KP, LINEAR_KI, LINEAR_KD,
        new TrapezoidProfile.Constraints(LINEAR_MAX_VELOCITY, LINEAR_MAX_ACCELERATION));
