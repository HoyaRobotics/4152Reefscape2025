    ...
    private void configureDriverButtonBindings() {
        ...
        switch (Constants.intakeVersion) {
            ...
            default:
                ...
                driveController
                        .scoreBarge()
                        .whileTrue(AutoAlign.autoScoreBargeV2(drive, superStructure, algaeIntake, led));
        ...
        */
        ...
        driveController
                ...
                .whileTrue(AutoAlign.autoAlignAndPlace(
                        drive, superStructure, SuperStructurePose.L4, intake, led, driveController.driveY()));
        driveController
                .moveToL3(false)
                .whileTrue(AutoAlign.autoAlignAndPlace(
                        drive, superStructure, SuperStructurePose.L3, intake, led, driveController.driveY()));
        driveController
                .moveToL2(false)
                .whileTrue(AutoAlign.autoAlignAndPlace(
