...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains =
            // new Slot0Configs().withKP(0.1).withKI(0).withKD(0.0).withKS(0.15070).withKV(1.30387786);
            new Slot0Configs().withKP(0.1).withKI(0).withKD(0.0).withKS(0.15070).withKV(0.78178); // kS = 0, kV = 0.124
